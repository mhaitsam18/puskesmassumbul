        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                    <li class="active" style="color: #fff"><a style="color: #fff" href="#"><i class="fa fa-cube"></i> Logo /</a> Tabel Data</li>
                </ol>
            </div>
        </div>
        <br>
                        ...
                        <tbody>
                            ...
                            echo '
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="'.site_url('server/logo/form/edit/logo').'" class="btn btn-primary btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-logo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
