<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                    <li class="active" style="color: #fff"><a style="color: #fff" href="#"><i class="fa fa-cube"></i> User Admin /</a> Tabel Data</li>
                </ol>
            </div>
        </div>
        <br>
        ...
        <!-- content -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <a href="<?php echo base_url(); ?>server/useradmin/form/add"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</button></a>
            <br><br>
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> List Data User Admin
                </div>
                    ...
                    <table id="example2" class="table table-bordered table-striped table-responsive nowrap">
                        <thead>
                            <tr>
                              ...
                              <th style="background:#ddd;text-align: center;">ROLE</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>'.$useradmins['nama_lengkap'].'</td>
                                <td>'.$useradmins['username'].'</td>
                                <td align="center">'.$useradmins['role_name'].'</td>
                                <td align="center">'.$useradmins['active'].'</td>
                                <td width="100px;">
                                    <center>
                                        <a href="'.site_url('server/useradmin/form/edit/' . $useradmins['id_login']).'" class="btn btn-primary btn-sm">
                                        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit</a>

                                        
                                        <a href="javascript:;" data-id="'.$useradmins['id_login'].'" data-toggle="modal" data-target="#modal-hapus-useradmin" class="btn btn-danger btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-useradmin" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
