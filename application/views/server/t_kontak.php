        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                    <li class="active" style="color: #fff"><a style="color: #fff" href="#"><i class="fa fa-cube"></i> Kontak /</a> Tabel Data</li>
                </ol>
            </div>
        </div>
        <br>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> Data Kontak
                </div>
                    ...
                    <table id="example2" class="table table-bordered table-striped table-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="'.site_url('server/kontak/form/edit/' . $kontaks['c_id']).'" class="btn btn-primary btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-kontak" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
