        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                    <li class="active" style="color: #fff"><a style="color: #fff" href="#"><i class="fa fa-cube"></i> Nama APlikasi /</a> Tabel Data</li>
                </ol>
            </div>
        </div>
        <br>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> Data Nama APlikasi
                </div>
                <div class="panel-body" id="panel-body">
                    ...
                    <table id="example2" class="table table-bordered table-striped table-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            echo '
                            <tr>
                                <td>'.$juduls['c_value'].'</td>
                                <td>
                                    <center>
                                        <a href="'.site_url('server/judul/form/edit/' . $juduls['c_id']).'" class="btn btn-primary btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-judul" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
