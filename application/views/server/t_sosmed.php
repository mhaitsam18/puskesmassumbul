<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                    <li class="active" style="color: #fff"><a style="color: #fff" href="#"><i class="fa fa-cube"></i> Sosial Media /</a> Tabel Data</li>
                </ol>
            </div>
        </div>
        <br>
        ...
        <!-- content -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
           <!--  <a href="<?php echo base_url(); ?>server/sosmed/form/add"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</button></a> -->
            <!-- <br><br> -->
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> List Data Sosial Media
                </div>
                    ...
                    <table id="example2" class="table table-bordered table-striped table-responsive nowrap">
                        <thead>
                            <tr>
                              ...
                              <th style="background:#ddd;text-align: center;">AKUN</th>
                              <th style="background:#ddd;text-align: center;">URL</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>'.$sosmeds['sm_desc'].'</td>
                                <td>'.$sosmeds['sm_value'].'</td>
                                <td>
                                    <center>
                                        <a href="'.site_url('server/sosmed/form/edit/' . $sosmeds['sm_id']).'" class="btn btn-primary btn-sm" title="Edit">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-sosmed" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
