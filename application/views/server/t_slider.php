<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <div>
                <ol class="breadcrumb" style="background-color: #3c8dbc">
                    <li class="active" style="color: #fff"><a style="color: #fff" href="#"><i class="fa fa-cube"></i> Slider /</a> Tabel Data</li>
                </ol>
            </div>
        </div>
        <br>
        ...
        <!-- content -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px;padding-right: 20px">
            <a href="<?php echo base_url(); ?>server/slider/form/add"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</button></a>
            <br><br>
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <i class="fa fa-th"></i> List Data Slider
                </div>
                    ...
                    <table id="example2" class="table table-bordered table-striped table-responsive nowrap">
                        <thead>
                            <tr>
                              ...
                              <th style="background:#ddd;text-align: center;">NAMA FILE</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>'.$sliders['slid_image'].'</td>
                                <td>
                                    <center>
                                        <a href="'.site_url('server/slider/form/edit/' . $sliders['slid_id']).'" class="btn btn-primary btn-sm">
                                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span> View</a>

                                        <a href="javascript:;" data-id="'.$sliders['slid_id'].'" data-toggle="modal" data-target="#modal-hapus-slider" class="btn btn-danger btn-sm">
...
<!-- modal konfirmasi-->
<div id="modal-hapus-slider" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
